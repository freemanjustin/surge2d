      MODULE mod_strings
!
!svn $Id: mod_strings.F 795 2016-05-11 01:42:43Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &      'Message Passage: multi-model coupling ............'/)
        ...
        character (len=80) :: my_fc = "/apps/intel-ct/fc-wrapper/ifort"
        character (len=160) :: my_fflags = "-no-heap-arrays -fp-model fast=1 -O3 -xHost -ip -fpp -ip -O3 -free -free -free"
